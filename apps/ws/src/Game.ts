...
import { Message } from '@repo/message'; // Import the Message constants from 'messages'
import { db } from './db';
...
const { INIT_GAME, MOVE, GAME_ENDED } = Message; // Destructure the constants from the Message object
