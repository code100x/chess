...
export function BackgroundSvg() {
  ...
  useEffect(() => {
    dashOffset.value = withTiming(0, { duration: 15000 });
  }, []);
  ...
  return (
    <View className="absolute -left-1/2 -right-1/2 bottom-0 top-0 aspect-square h-full">
      <Svg fill="none" viewBox="0 0 120 120" width="100%" height="100%">
        <AnimatedPath
