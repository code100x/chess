...
export const Game = () => {
  ...
  const [result, setResult] = useState<'WHITE_WINS' | 'BLACK_WINS' | 'DRAW' | typeof OPPONENT_DISCONNECTED | null>(
    null
  );
  ...
  return (
    <div className="">
      ...
      {result && <div className="justify-center flex pt-4 text-white">{result} z</div>}
