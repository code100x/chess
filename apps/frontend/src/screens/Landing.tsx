...
export const Landing = () => {
  ...
  return (
    <div className="w-full bg-[rgb(5_15_17)] mx-auto">
      <header className="font-mono text-white pt-8 pb-9 w-full shadow-lg">
      ...
      <div className="font-Inter w-[96%] max-w-screen-lg mx-auto">
        <div className="mt-[4rem] lg:mt-[8rem] flex flex-col-reverse lg:grid lg:grid-cols-[45%,1fr] gap-20 lg:gap-28">
          <div>
            ...
            <p className="text-xl text-[rgb(255_255_255/55%)] mt-6 text-white">
      ...
      <div
        style={{
          background:
            'linear-gradient(45deg, rgba(173, 255, 133, 0) 0%, rgba(173, 255, 133, .15) 53.953923405827695%, rgba(173, 255, 133, 0) 100.45045045045045%)',
        }}
        className="mt-32 w-[96%] max-w-screen-lg mx-auto px-14 py-14 rounded-[36px]"
      >
        <div className="lg:grid grid-cols-[45%,1fr] gap-28">
          ...
          <div className="mt-16 lg:mt-0">
            ...
            <a
              ...
              target="_blank"
              className="mt-10 text-white rounded-xl px-2 py-2 border  border-slate-400 hover:border-slate-100 bg-transparent w-full text-2xl flex gap-10 items-center justify-center"
            >
              <img
                className="w-12 h-12"
      ...
      <footer className="mt-40 border-t border-gray-600/50 py-16 text-white">
