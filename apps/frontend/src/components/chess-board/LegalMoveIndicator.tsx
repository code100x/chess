const LegalMoveIndicator = ({ isPiece, isMainBoxColor }: { isPiece: boolean; isMainBoxColor: boolean }) => {
    return <div className="absolute z-[100] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    {isPiece ? (
        <div
