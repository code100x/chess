...
const PlaceholderDot: React.FC<PlaceholderDotProps> = React.memo(({ x, y, selectableSquares, moveTo }) => {
  ...
  return (
    ...
    >
      <Animated.View style={[{ borderRadius: pieceSize }, styles.placeholder, rPlaceholderStyle]} />
    </View>
  );
});
