...
const HighlightedSquareComponent = React.forwardRef<HighlightedSquareRefType, HighlightedSquareProps>(
  ({ style }, ref) => {
    const {
    ...
    return <Animated.View style={[styles.highlightedSquare, style, rHighlightedSquareStyle]} />;
  }
);
