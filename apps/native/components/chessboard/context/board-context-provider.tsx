...
import { BoardOperationsContextProvider, BoardOperationsRef } from './board-operations-context';
...
const ChessboardContextProviderComponent = React.forwardRef<ChessboardRef, BoardContextProviderProps>(
  ({ children, fen }, ref) => {
          ...
          <ChessEngineContext.Provider value={chess}>
            <BoardSetterContext.Provider value={setBoard}>
              <BoardRefsContextProvider ref={chessboardRef}>
                <BoardOperationsContextProvider ref={boardOperationsRef} controller={chessboardController}>
                  {children}
...
const ChessboardContextProvider = React.memo(ChessboardContextProviderComponent);
